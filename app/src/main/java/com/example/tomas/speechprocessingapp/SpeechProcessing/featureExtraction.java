...
import com.example.tomas.speechprocessingapp.SpeechProcessing.features.BarkEnergy;
import com.example.tomas.speechprocessingapp.SpeechProcessing.features.MFCC;
...
public class featureExtraction {
    ...
    public List<float[]> feat_ext(float[] signal, int Fs) {
        ...
        List<float[]> bbe_signal = new ArrayList<float[]>();
